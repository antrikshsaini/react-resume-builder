              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Fill out your details in <strong>6</strong> easy steps
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="card-wrapper col-md">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Choose a template from provided templates
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="card-wrapper col-md">
              <div className="card col-md">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    That's it! Now you can download your resume in pdf form
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="features-content align-items-center justify-content-center ">
            <div className="wrapper row">
              <div className="text-content col-md">
                ...
                <div className="text">
                  With out easy to use services you can build your resume in
            ...
            <div className="wrapper row">
              ...
              <div className="text-content col-md">
                ...
                <div className="text">
                  We provide multiple ready to use templates to speed up resume
                  building process
                </div>
              </div>
            </div>
            ...
            <div className="wrapper row">
              ...
              <div className="text-content col-md">
                ...
                <div className="text">
                  With our easy to use services you can create resume best
